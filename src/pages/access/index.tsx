...
const Access = () => {
    return(
        ...
        <>
        <Navbar/>
        <div className="flex flex-col md:flex-row md:justify-center md:items-center md:h-screen bg-gray-50">
            <div className="mr-0 md:mr-8 justify-center">
                ...
                <button className="bg-blue-500 text-white rounded-full px-5 py-2 mb-1 md:ml-20 md:">Learn More</button>
            </div>
